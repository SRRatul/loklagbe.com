                                        ...
                                        <tr data-status="<?php echo $booking['status']; ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if ($booking['status'] === 'pending'): ?>
                                                    <a href="bookings.php?id=<?php echo $booking['id']; ?>&status=confirmed"
                                                ...
                                                <?php if ($booking['status'] === 'confirmed'): ?>
                                                    <a href="bookings.php?id=<?php echo $booking['id']; ?>&status=completed"
                                                ...
                                                <?php if ($booking['status'] === 'pending' || $booking['status'] === 'confirmed'): ?>
                                                    <a href="bookings.php?id=<?php echo $booking['id']; ?>&status=cancelled"
