...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verify reCAPTCHA
    $recaptcha_secret_key = '6LcBSgkrAAAAANlAwipMLDypTaQokdh5bdLWZa6P'; // Replace with your secret key
    ...
    <div class="signup-container">
        <div class="signup-box">
            ...
            <form action="signup.php" method="POST">
                ...
                <!-- Google reCAPTCHA -->
                <div class="g-recaptcha" data-sitekey="6LcBSgkrAAAAAEZwiV5_QJAZqlu18W3-IXxrsHcN"></div>
                <br><br>
